...
import 'package:notes/semester_vi/service/services_or.dart';

class UserFilterDemoOr extends StatefulWidget {
  UserFilterDemoOr() : super();

  final String title = "Notes";

  @override
  UserFilterDemoOrState createState() => UserFilterDemoOrState();
}
...
class UserFilterDemoOrState extends State<UserFilterDemoOr> {
