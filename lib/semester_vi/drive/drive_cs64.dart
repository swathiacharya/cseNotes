...
import 'package:notes/semester_vi/service/services_os.dart';

class UserFilterDemoOs extends StatefulWidget {
  UserFilterDemoOs() : super();

  final String title = "Notes";

  @override
  UserFilterDemoOsState createState() => UserFilterDemoOsState();
}
...
class UserFilterDemoOsState extends State<UserFilterDemoOs> {
