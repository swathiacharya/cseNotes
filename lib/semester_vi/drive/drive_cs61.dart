...
import 'package:notes/semester_vi/service/services_cns.dart';

class UserFilterDemoCns extends StatefulWidget {
  UserFilterDemoCns() : super();

  final String title = "Notes";

  @override
  UserFilterDemoCnsState createState() => UserFilterDemoCnsState();
}
...
class UserFilterDemoCnsState extends State<UserFilterDemoCns> {
