...
import 'package:notes/semester_vi/service/services_cg.dart';

class UserFilterDemoCg extends StatefulWidget {
  UserFilterDemoCg() : super();

  final String title = "Notes";

  @override
  UserFilterDemoCgState createState() => UserFilterDemoCgState();
}
...
class UserFilterDemoCgState extends State<UserFilterDemoCg> {
