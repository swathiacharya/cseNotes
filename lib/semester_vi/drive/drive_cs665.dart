...
import 'package:notes/semester_vi/service/services_py.dart';

class UserFilterDemoPy extends StatefulWidget {
  UserFilterDemoPy() : super();

  final String title = "Notes";

  @override
  UserFilterDemoPyState createState() => UserFilterDemoPyState();
}
...
class UserFilterDemoPyState extends State<UserFilterDemoPy> {
